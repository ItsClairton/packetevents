...
public class ArmorMaterials {
    ...
    private static final Map<String, ArmorMaterial> MATERIAL_MAP = new Object2ObjectOpenHashMap<>();
    private static final Byte2ObjectMap<Int2ObjectMap<ArmorMaterial>> MATERIAL_ID_MAP = new Byte2ObjectOpenHashMap<>();
    ...
    public static ArmorMaterial getById(ClientVersion version, int id) {
        ...
        Int2ObjectMap<ArmorMaterial> idMap = MATERIAL_ID_MAP.get((byte) index);
        return idMap.get(id);
    }
